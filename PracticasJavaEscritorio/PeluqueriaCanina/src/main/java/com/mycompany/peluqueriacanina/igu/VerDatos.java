...
public class VerDatos extends javax.swing.JFrame {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnEditar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    // End of variables declaration//GEN-END:variables
        ...
        private void cargarTabla() {
            //Definir el modelo que queramos de la tabla
            DefaultTableModel modeloTabla = new DefaultTableModel(){
                //Hacemos que fila y columna no sean editables
                @Override
            ...
            String titulos[] = {"Num", "Nombre", "Raza", "Color", "Alergico", "At. Especial", "Observaciones", "Dueño", 
                "Celular"};
            ...
            //Recorrer la lista y traer cada uno de los elementos en la tabla
            if(listaMascotas != null){
                for(Mascota masco : listaMascotas){
                    Object[] objeto = {masco.getNum_cliente(), masco.getNombre(), masco.getRaza(), masco.getColor(), 
                    masco.getAlergico(), masco.getAtencion_especial(), masco.getObservaciones(), 
